...
public class TaskRecord {
    ...
    // Split-up metrics (in milliseconds)
    private double networkDelayMs;
    private double queueDelayMs;
    ...
    public double getGpuMemoryMb() {
        return gpuMemoryMb;
    }

    public void setGpuMemoryMb(double gpuMemoryMb) {
    ...
    public int getRemainingDeps() {
        return remainingDeps;
    }

    public void setRemainingDeps(int remainingDeps) {
        this.remainingDeps = remainingDeps;
    }

    public void decrementRemainingDeps() {
        this.remainingDeps--;
    }
    ...
    public double getReadyTimeMs() {
        return readyTimeMs;
    }

    public void setReadyTimeMs(double readyTimeMs) {
    ...
    public void setScheduledTimeMs(double scheduledTimeMs) {
    ...
    public double getFinishTimeMs() {
        return finishTimeMs;
    }

    public void setFinishTimeMs(double finishTimeMs) {
        this.finishTimeMs = finishTimeMs;
    }

    public int getAssignedTier() {
        return assignedTier;
    }

    public void setAssignedTier(int tier) {
        this.assignedTier = tier;
    }

    public int getAssignedDatacenterId() {
        return assignedDatacenterId;
    }

    public void setAssignedDatacenterId(int dcId) {
        this.assignedDatacenterId = dcId;
    }
    ...
    public void setAssignedVmId(int vmId) {
    ...
    public void setCloudletId(long cloudletId) {
        this.cloudletId = cloudletId;
    }

    public double getNetworkDelayMs() {
        return networkDelayMs;
    }

    public void setNetworkDelayMs(double networkDelayMs) {
        this.networkDelayMs = networkDelayMs;
    }

    public double getQueueDelayMs() {
        return queueDelayMs;
    }

    public void setQueueDelayMs(double queueDelayMs) {
        this.queueDelayMs = queueDelayMs;
    }

    public double getProcessingDelayMs() {
    ...
    public double getUploadDelayMs() {
        return uploadDelayMs;
    }

    public void setUploadDelayMs(double uploadDelayMs) {
        this.uploadDelayMs = uploadDelayMs;
    }

    public double getDownloadDelayMs() {
        return downloadDelayMs;
    }

    public void setDownloadDelayMs(double downloadDelayMs) {
