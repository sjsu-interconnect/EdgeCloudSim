...
public class DagSchedulingTestHarness {
    ...
    private static void testSchedulingPolicies() throws Exception {
        ...
        edu.boun.edgecloudsim.dagsim.scheduling.ClusterState state = new edu.boun.edgecloudsim.dagsim.scheduling.ClusterState(
                0);
        ...
        // Create test task
        edu.boun.edgecloudsim.dagsim.scheduling.TaskContext task = new edu.boun.edgecloudsim.dagsim.scheduling.TaskContext();
    ...
    private static void testPolicy(
        ...
        edu.boun.edgecloudsim.dagsim.scheduling.PlacementDecision decision = policy.decide(task, state);
