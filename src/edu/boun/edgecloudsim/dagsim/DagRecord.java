...
/**
 * Represents a Directed Acyclic Graph (DAG) corresponding to a single inference
 * request.
 * Contains task records, metadata, and runtime state.
 */
public class DagRecord {
    private String dagId;
    private String applicationName = "AI_Workload"; // Default application name
    ...
    public double getSubmissionTimeEpochSec() {
        return submissionTimeEpochSec;
    }

    public void setSubmissionTimeEpochSec(double time) {
        this.submissionTimeEpochSec = time;
    }

    public long getSubmitAtSimMs() {
        return submitAtSimMs;
    }

    public void setSubmitAtSimMs(long submitAtSimMs) {
        this.submitAtSimMs = submitAtSimMs;
    }
    ...
    public void setNumInferenceSteps(int steps) {
    ...
    public boolean isHasControlnet() {
        return hasControlnet;
    }

    public void setHasControlnet(boolean hasControlnet) {
        this.hasControlnet = hasControlnet;
    }

    public Map<String, TaskRecord> getTasksById() {
        return tasksById;
    }
    ...
    public double getCompleteTimeMs() {
        return completeTimeMs;
    }

    public void setCompleteTimeMs(double completeTimeMs) {
        this.completeTimeMs = completeTimeMs;
    }
